...
<a href="https://goreportcard.com/badge/github.com/ExploitSuite/cdncheck"><img src="https://goreportcard.com/badge/github.com/ExploitSuite/cdncheck"></a>
<a href="https://pkg.go.dev/github.com/ExploitSuite/cdncheck/pkg/cdncheck"><img src="https://img.shields.io/badge/go-reference-blue"></a>
<a href="https://github.com/ExploitSuite/cdncheck/releases"><img src="https://img.shields.io/github/release/projectdiscovery/cdncheck"></a>
...
```sh
go install -v github.com/ExploitSuite/cdncheck/cmd/cdncheck@latest
```
...
The library can be used by importing `github.com/ExploitSuite/cdncheck`. here follows a basic example:
